...
// если сумма к оплате превышает количество кредитов на
// счету, выводи в консоль сообщение 'Недостаточно средств на счету!'.
...
userOrdered = prompt('Пожалуйста, укажите сколько дроидов хотите купить');

if (userOrdered === null) {
  alert('Отменено пользователем!');
} else {
  totalPrice = pricePerDroid * userOrdered;
}

if (credits < totalPrice) {
  message = 'Недостаточно средств на счету!';
} else {
  message = `Вы купили ${userOrdered} дроид(ов), на счету осталось ${credits -
    totalPrice} кредит(ов).`;
}
